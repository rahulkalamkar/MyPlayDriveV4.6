...
public class SlidingUpPanelLayout extends ViewGroup {
	...
	public enum SlideState {
		DRAGGING, EXPANDED, COLLAPSED, ANCHORED, HIDDEN
	}
		...
		if (attrs != null) {
			...
			if (ta != null) {
				...
				mAnchorPoint = ta.getFloat(
						R.styleable.SlidingUpPanelLayout_anchorPoint, 1.0f);
			}
	...
	public void setInitial(SlideState slid) {
		this.mSlideState = slid;
	}
