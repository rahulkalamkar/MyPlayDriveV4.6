...
//    	System.out.println(motionEvent.getRawX() + " :::::: " + motionEvent.getRawY());
        ...
        if(blockShowcaseTouch && distanceFromFocus <= showcaseDrawer.getBlockedRadius()){
        	return true;
        }
    ...
    private boolean blockShowcaseTouch = false;
    
    public void setBlockShowCaseTouches(boolean value){
    	blockShowcaseTouch = value;
    }
