...
public class GSResponse {
     ...
     * Code '0' indicates success, any other number indicates failure. For the complete list of server error codes, see the <a target="_blank" href="http://wiki.gigya.com/030_API_reference/030_Response_Codes_and_Errors">Error Codes</a> table.
     *
     ...
     * Please refer to Gigya's <a target="_blank" href="http://wiki.gigya.com/030_API_reference/020_REST_API">REST API reference</a>, for a list of response data structure per method request.
