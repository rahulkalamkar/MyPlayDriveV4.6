...
public class GSRequest {
     ...
     * our <a target="_blank" href="http://wiki.gigya.com/020_Developer_Guide/67_REST/OAuth1"
     ...
     *                     example: "socialize.getUserInfo". Please refer to our <a target="_blank"
     ...
     *                     API method to call. Please refer to our <a target="_blank"
     *                     href="http://wiki.gigya.com/030_API_reference/020_REST_API"
    ...
    public GSResponse send(int timeoutMS) {
        ...
        } catch (SocketTimeoutException exSocketTimeout) {
            return new GSResponse(this.apiMethod, this.params, 504002,
                    exSocketTimeout.toString(), logger);
        } catch (ConnectException exConnectTimeout) {
            return new GSResponse(this.apiMethod, this.params, 504002,
                    exConnectTimeout.toString(), logger);
        } catch (Exception ex) {
