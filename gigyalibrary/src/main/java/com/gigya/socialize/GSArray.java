...
public class GSArray implements Serializable, Iterable<Object> {
    ...
    public void add(String val) { array.add(val); }

    public void add(boolean val) { array.add(val); }

    public void add(int val) { array.add(val); }

    public void add(long val) { array.add(val); }

    public void add(GSObject val) { array.add(val); }

    public void add(GSArray val) { array.add(val); }

    public void add(double val) { array.add(val); }
