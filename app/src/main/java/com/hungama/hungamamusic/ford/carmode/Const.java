...
public class Const {
	...
	public static final String PREFS_NAME = "SyncPlayerPrefs";
	...
	// Default values
	public static final String PREFS_DEFAULT_APPNAME = "Hungama Music";
	...
	public static final class Transport {
		...
		public static final String PREFS_DEFAULT_TRANSPORT_IP = "192.168.1.36";
