...
public class QuickActionPlayerQueueItemSelect extends PopupWindows implements
	...
	public void setOnContextItemSelectedListener(
			OnContextItemSelectedListener listener) {
		mOnLoginOptionSelectedListener = listener;
	}

	boolean isTextSizeChange;
	private OnContextItemSelectedListener mOnLoginOptionSelectedListener;
	 ...
	 *            Context
	 */
	public QuickActionPlayerQueueItemSelect(Context context,
			String[] arr_options, boolean isTextSizeChange) {
		this(context, VERTICAL, arr_options, isTextSizeChange);
	...
	public QuickActionPlayerQueueItemSelect(Context context, int orientation,
			String[] arr_options, boolean isTextSizeChange) {
		super(context);
		this.context = context;
		this.isTextSizeChange = isTextSizeChange;
		...
		if (mOrientation == HORIZONTAL) {
			...
			setRootViewId(R.layout.popup_vertical_editorpics);
		}
	...
	public void setRootViewId(int id) {
		...
		LayoutParams params = mScroller.getLayoutParams();
	...
	public void setOnDismissListener(
			QuickActionPlayerQueueItemSelect.OnDismissListener listener) {
	...
	public interface OnActionItemClickListener {
		public abstract void onItemClick(
				QuickActionPlayerQueueItemSelect source, int pos, int actionId);
	}
			...
			if (convertView == null) {
				if (isTextSizeChange) {
					convertView = LayoutInflater.from(context).inflate(
							R.layout.list_item_options_fullplayer, null);

				} else
					convertView = LayoutInflater.from(context).inflate(
							R.layout.list_item_options_editorpics, null);
