...
public class QuickActionEditerPics extends PopupWindows implements
	 ...
	 *            Context
	 */
	public QuickActionEditerPics(Context context, String[] arr_options,
			boolean isTextSizeChange) {
	...
	public QuickActionEditerPics(Context context, int orientation,
	...
	public void setOnDismissListener(
			QuickActionEditerPics.OnDismissListener listener) {
	...
	public interface OnActionItemClickListener {
		public abstract void onItemClick(QuickActionEditerPics source, int pos,
				int actionId);
	}
