 ...
 */
public abstract class FlexibleDividerDecoration extends
		...
		if (builder.mPaintProvider != null) {
			...
			if (builder.mDrawableProvider == null) {
				...
				mDrawableProvider = new DrawableProvider() {
					@Override
					public Drawable drawableProvider(int position,
							RecyclerView parent) {
						return divider;
					}
				};
	...
	public void onDrawOver(Canvas c, RecyclerView parent,
		...
		for (int i = 0; i < childCount - 1; i++) {
			...
			case PAINT:
				...
				c.drawLine(bounds.left, bounds.top, bounds.right,
						bounds.bottom, mPaint);
				break;
			case COLOR:
				mPaint.setColor(mColorProvider.dividerColor(childPosition,
						parent));
				mPaint.setStrokeWidth(mSizeProvider.dividerSize(childPosition,
						parent));
				c.drawLine(bounds.left, bounds.top, bounds.right,
						bounds.bottom, mPaint);
				break;
	...
	@Override
	public void getItemOffsets(Rect rect, View v, RecyclerView parent,
			RecyclerView.State state) {
