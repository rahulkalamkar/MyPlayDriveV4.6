...
public class QuickActionVideoMore extends PopupWindows implements
	...
	public void setOnVideoPlayerMoreSelectedListener(
			OnVideoPlayerMoreSelectedListener listener) {
		mOnOptionSelectedListener = listener;
	}

	private OnVideoPlayerMoreSelectedListener mOnOptionSelectedListener;

	public interface OnVideoPlayerMoreSelectedListener {
	 ...
	 *            Context
	 */
	public QuickActionVideoMore(Context context, Boolean isFromHeader) {
		this(context, VERTICAL, isFromHeader);
	...
	public QuickActionVideoMore(Context context, int orientation,
			boolean isFromHeader) {
		super(context);
	...
	public void setRootViewId(int id) {
		...
		if (isFromHeader) {
			arr_options = new String[] {  txtDownloadMp4, txtTrendThis };
			arr_images = new int[] {
					R.drawable.icon_general_download_grey_mp4_gray,
					R.drawable.icon_general_download_grey_mp4_gray };
		} else {
			arr_options = new String[] { txtComments, txtShare };
			arr_images = new int[] { R.drawable.ic_comments,
					R.drawable.icon_media_details_share_grey };
		}
		fillUpList();
	}
	...
	public void setOnDismissListener(
			QuickActionVideoMore.OnDismissListener listener) {
	...
	public interface OnActionItemClickListener {
		public abstract void onItemClick(QuickActionVideoMore source, int pos,
				int actionId);
	}
	...
	public void onItemClick(AdapterView<?> arg0, final View arg1, int arg2,
		...
		// mItemClickListener.onItemClick(null, arg2, 0);
		mOnOptionSelectedListener.onItemSelected(arr_options[arg2]);
		dismiss();
	}
