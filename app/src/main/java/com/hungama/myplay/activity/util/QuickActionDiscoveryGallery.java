...
public class QuickActionDiscoveryGallery extends PopupWindows implements
	...
	String mFlurrySourceSection;

	public void setOnDiscoverySelectedListener(
			OnDiscoverySelectedListener listener) {
		mOnLoginOptionSelectedListener = listener;
	}

	private OnDiscoverySelectedListener mOnLoginOptionSelectedListener;

	public interface OnDiscoverySelectedListener {
	 ...
	 *            Context
	 */
	public QuickActionDiscoveryGallery(Context context, String[] arr_options,
			String mFlurrySourceSection) {
		this(context, VERTICAL, arr_options, mFlurrySourceSection);
	}
	...
	public QuickActionDiscoveryGallery(Context context, int orientation,
			String[] arr_options, String mFlurrySourceSection) {
		super(context);
		this.context = context;
		mOrientation = orientation;
		mInflater = (LayoutInflater) context
				.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
		this.mFlurrySourceSection = mFlurrySourceSection;
	...
	public void setOnDismissListener(
			QuickActionDiscoveryGallery.OnDismissListener listener) {
	...
	public interface OnActionItemClickListener {
		public abstract void onItemClick(QuickActionDiscoveryGallery source,
