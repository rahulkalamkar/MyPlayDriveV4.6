...
public final class SwipeDismissListOffline implements View.OnTouchListener {
	...
	/**
	 * Defines the mode a {@link SwipeDismissListOffline} handles multiple
	 * undos.
	 */
	 ...
	 * {@link #setSwipeDirection(de.timroes.swipetodismiss.SwipeDismissListOffline.SwipeDirection)}
	 ...
	 */
	public SwipeDismissListOffline(AbsListView listView,
	...
	public void dismissCall(ListView listView, int pos) {
		// dismiss
		mDownPosition = pos;// mListView.getPositionForView(view);
		...
		mDownView = listView.getChildAt(wantedChild);
		// mDownView = mListView.getChildAt(pos);
		final View downView = mDownView; // mDownView gets null'd before
											// animation ends
		final int downPosition = mDownPosition;
		++mDismissAnimationRefCount;
