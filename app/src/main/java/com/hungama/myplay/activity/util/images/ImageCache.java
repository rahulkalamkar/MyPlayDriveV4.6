...
public class ImageCache {
	...
	private void init(ImageCacheParams cacheParams) {
		...
		if (mCacheParams.memoryCacheEnabled) {
			if (BuildConfig.DEBUG) {
				Logger.d(TAG, "Memory cache created (size = "
	...
	// //Logger.i(TAG, "Start getBitmapFromMemCache "+data);
	// final Bitmap memBitmap = mMemoryCache.get(data);
	// //Logger.i(TAG, "Finish getBitmapFromMemCache "+data);
	// if (memBitmap != null) {
	// if (BuildConfig.DEBUG) {
	...
	// return memBitmap;
	// }else{
	// Logger.d(TAG, "Memory cache miss");
	// }
	// }
	// return null;
	// }
	...
	public static File getDiskCacheDir(Context context, String uniqueName) {
		...
		if (context != null) {
			cachePath = Environment.MEDIA_MOUNTED.equals(Environment
					...
					context).getPath()
					: "")
					: (context.getCacheDir() != null ? context.getCacheDir()
							.getPath() : "");
		}
